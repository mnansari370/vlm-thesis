...
Run in qwen_env, from repo root:
  CUDA_VISIBLE_DEVICES=1 ~/miniconda3/envs/qwen_env/bin/python -m v2.distill.eval_control \
      --student v2/outputs/distill/student.pt --n 200 --K 128
"""
...
def main():
    ...
    ap.add_argument("--out", default="v2/outputs/distill/control_result.json")
