...
Run in qwen_env, from repo root (pilot TRAIN slice = validation[0:3000]):
  CUDA_VISIBLE_DEVICES=0 ~/miniconda3/envs/qwen_env/bin/python -m v2.distill.cache_teacher \
...
def main():
    ...
    ap.add_argument("--out", default="v2/outputs/distill/teacher_docvqa_train.pt")
