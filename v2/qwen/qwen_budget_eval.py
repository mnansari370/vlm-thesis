...
def load(path="v2/outputs/qwen_budget_data_docvqa.json"):
...
def main():
    ...
    X, corr, tok, levels, y = load(f"v2/outputs/qwen_budget_data_{tag}.json")
    ...
    json.dump({"n":n,"oracle_gain":round(oracle_gain,2),"mlp_gain":round(realistic,2),
              ...
              open("v2/outputs/qwen_budget_eval.json","w"), indent=2)
