...
Usage:
  CUDA_VISIBLE_DEVICES=0 /home/nafees/miniconda3/envs/qwen_env/bin/python -m v2.qwen.qwen_kcurve \
...
def main():
    ...
    o = args.output or f"v2/outputs/qwen_kcurve_{args.dataset}.json"
