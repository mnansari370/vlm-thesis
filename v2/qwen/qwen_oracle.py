...
Usage:
  CUDA_VISIBLE_DEVICES=0 /home/nafees/miniconda3/envs/qwen_env/bin/python -m v2.qwen.qwen_oracle \
...
def main():
    ...
    json.dump({"dataset": args.dataset, "selector": args.selector, "n": n,
              ...
              open(f"v2/outputs/qwen_oracle_{args.dataset}_{args.selector}.json", "w"), indent=2)
