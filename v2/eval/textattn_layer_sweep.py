...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m v2.eval.textattn_layer_sweep --max-samples 300
"""
...
from v2.eval.evaluate_textvqa_highres_kcurve import HighResPruner, TEXTVQA_ANN, TEXTVQA_IMG, TEXTVQA_INSTR
...
def main():
    ...
    ap.add_argument("--output", default="v2/outputs/eval_textattn_layer_sweep.json")
    args = ap.parse_args()
