...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m v2.eval.evaluate_gqa_highres --k-values 64,128,256,576 --max-samples 300
"""
...
def main():
    ...
    ap.add_argument("--output", default="v2/outputs/eval_gqa_highres.json")
    args = ap.parse_args()
