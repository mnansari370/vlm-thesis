...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m v2.eval.evaluate_textvqa_highres_spread --max-samples 300
"""
...
def main():
    ...
    ap.add_argument("--output", default="v2/outputs/eval_textvqa_highres_spread.json")
