...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m v2.eval.evaluate_textvqa \
        --base --k-values 576,128,64,32 --max-samples 300
    CUDA_VISIBLE_DEVICES=0 python -m v2.eval.evaluate_textvqa \
        --checkpoint v2/outputs/stage1_quickfix/final.pt --k-values 576,128,64,32
"""
...
def main():
    ...
    ap.add_argument("--checkpoint", default="v2/outputs/stage1_quickfix/final.pt")
