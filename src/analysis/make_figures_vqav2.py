...
from src.analysis.flops_vqav2 import fastv_full_flops

OUT = "results/thesis_main/vqav2/figures"
...
for K, d in EVALS.items():
    preds = json.load(open(f"results/thesis_main/vqav2/{d}/generation_eval_10k.json"))["generation"]["predictions"]
...
base = {r["question_id"]: r for r in json.load(open("results/thesis_main/vqav2/cascade/base_k64.json"))["records"]}
