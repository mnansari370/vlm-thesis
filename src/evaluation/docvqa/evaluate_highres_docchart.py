...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m src.evaluation.docvqa.evaluate_highres_docchart --dataset chartqa --max-samples 300
    CUDA_VISIBLE_DEVICES=0 python -m src.evaluation.docvqa.evaluate_highres_docchart --dataset docvqa  --max-samples 300
"""
...
def main():
    ...
    out = args.output or f"results/thesis_main/highres/eval_highres_{args.dataset}.json"
