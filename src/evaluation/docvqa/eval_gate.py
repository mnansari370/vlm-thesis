...
Run in qwen_env, from repo root:
  CUDA_VISIBLE_DEVICES=0 ~/miniconda3/envs/qwen_env/bin/python -m src.evaluation.docvqa.eval_gate \
      --student results/thesis_main/highres/distill/student.pt --n 400 --K 128
Smoke:
...
def main():
    ...
    ap.add_argument("--out", default="results/thesis_main/highres/distill/gate_result.json")
