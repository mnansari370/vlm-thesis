...
Runs from repo root: cd /home/nafees/vlm-thesis && python -m src.evaluation.vqa.generate_and_score ...
"""
...
from src.data.vqav2 import VQACollator, build_vqav2_dataset
...
def load_model(model_type: str, cfg: Dict[str, Any], checkpoint_path: Optional[str]):
    if model_type == "dense":
        from src.models.dense import LlavaDenseVQAModel
        model = LlavaDenseVQAModel(cfg)
    elif model_type == "static":
        from src.models.static import LlavaStaticVQAModel
        model = LlavaStaticVQAModel(cfg)
    elif model_type == "dynamic":
        from src.models.dynamic_budget import LlavaDynamicVQAModel
