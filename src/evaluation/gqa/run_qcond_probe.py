...
Usage:
    python -m src.evaluation.gqa.run_qcond_probe --dataset textvqa_noocr --keep_ks 64,96 --layers 2,5,8
    python -m src.evaluation.gqa.run_qcond_probe --dataset gqa --keep_ks 64 --layers 2,5,8 --max_samples 12578
"""
...
from src.pruning.question_conditioned_selection.question_cond import QuestionCondLlava
...
def main():
    ...
    out_dir = make_output_dir("results/thesis_main/gqa", name)
