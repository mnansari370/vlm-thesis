...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m src.evaluation.gqa.evaluate_gqa \
        --checkpoint results/archived/stage1_full/final.pt \
...
def main():
    ...
    ap.add_argument("--checkpoint", default="results/archived/stage1_full/final.pt")
