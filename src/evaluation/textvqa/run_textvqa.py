...
Usage:
    python -m src.evaluation.textvqa.run_textvqa --method none --keep_k 576              # dense, validate ~58.2%
    python -m src.evaluation.textvqa.run_textvqa --method cls_attn --keep_k 288
    python -m src.evaluation.textvqa.run_textvqa --method none --keep_k 576 --use_ocr off  # no-OCR
    python -m src.evaluation.textvqa.run_textvqa --method cls_attn --keep_k 144 --return_confidence
"""
