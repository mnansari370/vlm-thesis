...
Usage:
  CUDA_VISIBLE_DEVICES=1 /home/nafees/miniconda3/envs/qwen_env/bin/python -m src.pruning.dynamic_budget.qwen_oracle_qc \
...
def main():
    ...
    json.dump({"dataset":args.dataset,"selector":"textattn_qc","n":n,"curve":curve,
              ...
              open(f"results/thesis_main/highres/qwen_oracle_{args.dataset}_qc.json","w"),indent=2)
