...
#          scripts/training/hpc/generation_eval.sh dense \
#          results/dense_v1/best_model.pt \
#          results/dense_v1/generation_eval_full.json
#
#   sbatch --job-name=vqa2_gen_eval_static_k288 \
#          scripts/training/hpc/generation_eval.sh static \
#          results/static_k288_v1/best_model.pt \
#          results/static_k288_v1/generation_eval_full.json \
#          288
