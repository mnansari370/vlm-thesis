...
Usage
-----
    python -m src.evaluation.gqa.run_dense_testdev --output_name testdev_dense_honest
    python -m src.evaluation.gqa.run_dense_testdev --output_name testdev_dense_pad --image_pad
"""
...
def main():
    ...
    out_dir = make_output_dir("results/thesis_main/gqa", args.output_name)
