...
-----
  ...
  python -m src.evaluation.gqa.run_static_testdev --method none --keep_k 576 --max_samples 200

  # full frontier point:
  python -m src.evaluation.gqa.run_static_testdev --method cls_attn --keep_k 288
"""
