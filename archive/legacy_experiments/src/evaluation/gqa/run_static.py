...
python -m src.evaluation.gqa.run_static \\
    --method none --keep_k 576 --max_samples 500 \\
    --output_name smoke_none_576

# Smoke tests:
python -m src.evaluation.gqa.run_static --method cls_attn  --keep_k 288 --max_samples 500
python -m src.evaluation.gqa.run_static --method random    --keep_k 288 --max_samples 500
python -m src.evaluation.gqa.run_static --method spatial_uniform --keep_k 288 --max_samples 500
python -m src.evaluation.gqa.run_static --method l2_norm   --keep_k 288 --max_samples 500
...
from src.data.gqa import GQAValDataset, collate_val
from src.models.static.static import SPATIAL_INDICES, StaticPrunedLlava
from src.analysis.flops import flops_row, print_flops_table
