...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m src.evaluation.docvqa.evaluate_highres_spread_docchart --dataset docvqa
"""
...
def main():
    ...
    json.dump(out, open(f"results/thesis_main/highres/eval_spread_{args.dataset}.json", "w"), indent=2)
    print(f"[saved] results/thesis_main/highres/eval_spread_{args.dataset}.json")
