...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m src.evaluation.docvqa.control_question_conditioning --max-samples 300
"""
...
def main():
    ...
    ap.add_argument("--output", default="results/thesis_main/highres/eval_control_qcond.json")
    args = ap.parse_args()
    K = args.K
    p = HighResPruner()
