...
Usage:
  python -m src.evaluation.pope.run_pope --method none --keep_k 576
  python -m src.evaluation.pope.run_pope --method cls_attn --keep_k 288
"""
...
def main():
    ...
    out_dir = make_output_dir("results/thesis_main/gqa", args.output_name or f"pope_{args.method}_k{args.keep_k}")
