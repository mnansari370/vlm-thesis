...
Usage: python -m src.evaluation.pope.run_pope_speculative --tau 0.55
"""
...
from src.evaluation.pope.run_pope import POPESubset, collate, SUBSETS, COCO_DIR, IMAGE_DIR, DENSE_REF_ACC
from src.models.static.static import StaticPrunedLlava
from src.analysis.flops import flops_row, N_TEXT_POPE
...
def main():
    ...
    out_dir = make_output_dir("results/thesis_main/gqa", args.output_name or f"pope_speculative_tau{int(args.tau*100):03d}")
