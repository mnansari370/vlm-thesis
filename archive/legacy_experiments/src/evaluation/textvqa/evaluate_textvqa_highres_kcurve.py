...
Usage:
    CUDA_VISIBLE_DEVICES=0 python -m src.evaluation.textvqa.evaluate_textvqa_highres_kcurve --self-test
    CUDA_VISIBLE_DEVICES=0 python -m src.evaluation.textvqa.evaluate_textvqa_highres_kcurve \
...
def main():
    ...
    ap.add_argument("--output", default="results/thesis_main/highres/eval_textvqa_highres_kcurve.json")
