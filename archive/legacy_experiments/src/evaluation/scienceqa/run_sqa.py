...
Usage:
  python -m src.evaluation.scienceqa.run_sqa --method none --keep_k 576                 # validate ~66.8%
  python -m src.evaluation.scienceqa.run_sqa --method cls_attn --keep_k 144 --return_confidence
"""
...
from src.analysis.flops import flops_row
...
def main():
    ...
    out_dir = make_output_dir("results/thesis_main/gqa", args.output_name or f"sqa_{args.method}_k{args.keep_k}")
