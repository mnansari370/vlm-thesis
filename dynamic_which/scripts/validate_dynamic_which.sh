...
echo
echo "Result tables:"
echo "  results/final_scope/tables/dynamic_which_final_report.md"
echo "  results/final_scope/tables/dynamic_which_textsim_full_final_summary.md"
echo "  results/final_scope/tables/qwen_textvqa_current_vs_ref_validation.md"
echo "  dynamic_which/RESULTS.md"
echo
echo "GPU RERUN (expensive; NOT needed unless reproducing the experiment):"
echo "  bash scripts/final_scope/run_dynamic_which_textsim_full_missing.sh   # 35 full finals"
