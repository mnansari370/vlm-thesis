...
echo "  results/tables/final_dense_static_dynamic_comparison.md  (section B)"
echo "  results/tables/static_final_summary.csv"
...
echo "  bash scripts/static/run_llava_static.sh   # LLaVA-1.5 cls_attn, GPU 0"
echo "  bash scripts/static/run_qwen_static.sh    # Qwen2.5-VL norm, GPU 1"
