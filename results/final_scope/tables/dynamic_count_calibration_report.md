...
- config: `results/final_scope/dynamic_count_configs/llava15_gqa.json`
...
- config: `results/final_scope/dynamic_count_configs/llava15_textvqa.json`
...
- config: `results/final_scope/dynamic_count_configs/llava15_docvqa.json`
...
- config: `results/final_scope/dynamic_count_configs/llava15_vqav2.json`
...
- config: `results/final_scope/dynamic_count_configs/qwen25vl7b_gqa.json`
...
- config: `results/final_scope/dynamic_count_configs/qwen25vl7b_textvqa.json`
...
- config: `results/final_scope/dynamic_count_configs/qwen25vl7b_textvqa_textsim.json`
...
- config: `results/final_scope/dynamic_count_configs/qwen25vl7b_docvqa.json`
...
- config: `results/final_scope/dynamic_count_configs/qwen25vl7b_vqav2.json`
