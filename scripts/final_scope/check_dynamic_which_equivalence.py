...
Envs / GPU (run each model under its own env):
  LLaVA : CUDA_VISIBLE_DEVICES=0 /home/nafees/miniconda3/envs/vlm_env/bin/python \
              -m scripts.final_scope.check_dynamic_which_equivalence --model llava15 --n 50
  Qwen  : CUDA_VISIBLE_DEVICES=1 /home/nafees/miniconda3/envs/qwen_env/bin/python \
              -m scripts.final_scope.check_dynamic_which_equivalence --model qwen25vl7b --n 50
"""
...
def load_dense_final(model: str):
    """Load results/final_scope/{model}/gqa/dense_final.jsonl, keyed by str(sample_id)."""
