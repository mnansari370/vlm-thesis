...
Writes per-cell config JSON to results/final_scope/dynamic_count_configs/{model}_{dataset}.json
and a calibration report to results/final_scope/tables/dynamic_count_calibration_report.md.
"""
...
REPORT = os.path.join("results", "final_scope", "tables", "dynamic_count_calibration_report.md")
