...
Envs / GPU:
  LLaVA : CUDA_VISIBLE_DEVICES=0 /home/nafees/miniconda3/envs/vlm_env/bin/python \
              -m scripts.dynamic_which.check_equivalence_extended --model llava15 --dataset textvqa
  Qwen  : CUDA_VISIBLE_DEVICES=1 /home/nafees/miniconda3/envs/qwen_env/bin/python \
              -m scripts.dynamic_which.check_equivalence_extended --model qwen25vl7b --dataset gqa
"""
