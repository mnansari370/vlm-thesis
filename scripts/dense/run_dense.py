...
Usage (after approval; from repo root):
  ...
  CUDA_VISIBLE_DEVICES=0 python -m scripts.dense.run_dense --model llava15 --dataset gqa
  CUDA_VISIBLE_DEVICES=0 python -m scripts.dense.run_dense --model llava15 --dataset textvqa
  CUDA_VISIBLE_DEVICES=0 python -m scripts.dense.run_dense --model llava15 --dataset vqav2
  CUDA_VISIBLE_DEVICES=0 HF_DATASETS_OFFLINE=1 python -m scripts.dense.run_dense --model llava15 --dataset docvqa

  # Qwen-2.5-VL cells (qwen_env):
  CUDA_VISIBLE_DEVICES=0 python -m scripts.dense.run_dense --model qwen25vl7b --dataset docvqa
  CUDA_VISIBLE_DEVICES=0 python -m scripts.dense.run_dense --model qwen25vl7b --dataset gqa
  ...
