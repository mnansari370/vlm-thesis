...
Reads (read-only; never modifies result JSON/JSONL):
  results/runs/qwen25vl7b/textvqa/dynamic_which_final_textsim_p{15,25,35,50,75}_ocr_on.json
Writes (real newline characters, LF):
  results/tables/dynamic_which_qwen_textvqa_final_summary.csv
  results/tables/dynamic_which_qwen_textvqa_final_summary.md
...
RESULT_DIR = os.path.join("results", "runs", MODEL, DATASET)
