...
manifest — and writes:
  ...
  results/tables/dynamic_which_dense_static_dynamic_comparison.csv
  results/tables/dynamic_which_dense_static_dynamic_comparison.md
  ...
  results/tables/dynamic_which_compact_by_dataset.md
