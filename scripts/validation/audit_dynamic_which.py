...
Writes (read-only w.r.t. result JSON/JSONL):
  results/tables/dynamic_which_full_final_matrix_audit.csv
  results/tables/dynamic_which_full_final_matrix_audit.md
...
MANIFEST_DIR = os.path.join("configs", "sample_ids")
