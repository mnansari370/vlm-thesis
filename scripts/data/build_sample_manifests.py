...
Writes `configs/sample_ids/{gqa,textvqa,docvqa,vqav2}.json`. CPU-only: it only
...
Usage (CPU):
  python -m scripts.data.build_sample_manifests --datasets vqav2,gqa,textvqa
  python -m scripts.data.build_sample_manifests --datasets docvqa     # needs HF cache
  python -m scripts.data.build_sample_manifests --datasets all --dry-run
"""
