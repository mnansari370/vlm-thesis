...
Usage (smoke test, 200 samples, GPU1):
    CUDA_VISIBLE_DEVICES=1 python scripts/data/budget_variance_gate.py \\
        --config configs/dynamic_budget/llava_dynamic_gate_smoke.yaml \\
        --output-dir results/gate_smoke_v1 \\
        --max-train 200 \\
        --max-val 200 \\
        --epochs 5
"""
...
from src.models.dynamic_budget.llava_wrapper import LlavaDynamicVQAModel
from src.models.dynamic_budget.budget_controller import BudgetController
from src.data.vqav2.vqav2 import build_vqav2_dataset
