...
# Default to the new dense experiment.
CONFIG="${1:-VQA_V2_early_proxy/dense/llava_dense_60k_10k_top3500.yaml}"
PROJECT_ROOT="${HOME}/vlm-thesis"

echo "============================================================"
echo "Starting SLURM dense job"
