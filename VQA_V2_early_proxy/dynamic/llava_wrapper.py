"""Dynamic-pruning wrapper: question-conditioned scorer + budget controller on a frozen backbone (exp1-5 ablations ran through this)."""
...
class LlavaDynamicVQAModel(nn.Module):
    ...
    def _build_dynamic_multimodal_inputs(
        ...
        budget_strategy = str(self.token_cfg.get("budget_loss_type", "target"))
