...
CONFIG="${1:-VQA_V2_early_proxy/dynamic/llava_dynamic_5k_1k_top3500_qconditioned_lam0003.yaml}"
PROJECT_ROOT="${HOME}/vlm-thesis"

echo "============================================================"
echo "Starting SLURM dynamic-pruning job"
